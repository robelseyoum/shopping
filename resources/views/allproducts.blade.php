        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <!-- here we pull products data from the database -->
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                    <div class="productinfo text-center">
                                       ...
                                       <!-- {{$product->id}} -->
                                        <!-- use this on termianal php artisan storage:link, after
                                            storing the image on starage to connect with public folder structure
                                        -->
                                    ...
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            <h2>£{{ $product->price }}</h2>
                                            <p>{{ $product->name }}</p>
                                            <!-- here we send product id to the rout -->
                            ...
                            <div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <!-- here we send product id to the rout -->
                                    <li><a href="{{ route('AddToCartProduct', ['id'=>$product->id]) }}"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
